                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-10">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form:form action = "modifyProduct" method="post" enctype="multipart/form-data" modelAttribute="product">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><input type = "submit" class="btn btn-primary btn-block" value="Modify Product"/></div>
                                            </div>
                                        </form:form>
                                    </div>
                                </div>
